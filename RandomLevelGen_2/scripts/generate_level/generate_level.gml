...
{
	instance_create_layer(_i, 0, "Instances", o_block);
	instance_create_layer(_i, room_height - grid_size, "Instances", o_block);
}

for (_i = grid_size; _i < room_height - grid_size; _i += grid_size)
{
	instance_create_layer(0, _i, "Instances", o_block);
	instance_create_layer(room_width - grid_size, _i, "Instances", o_block);
}
