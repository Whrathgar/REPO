...
if not place_meeting(x+xspeed, y, o_block) and not place_meeting(x+xspeed, y, o_block_perm)
{
	x += xspeed;
}

if not place_meeting(x, y+yspeed, o_block) and not place_meeting(x, y+yspeed, o_block_perm)
{
	y += yspeed;
}
